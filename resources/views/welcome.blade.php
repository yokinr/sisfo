...
<body class="antialiased">
    <div
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            ...
            {{-- <a href="{{ route('guest.pembelajaran') }}" wire:navigate
                class="border border-red-600 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Pembelajaran</a>
            <a href="{{ route('guest.pembagian-tugas') }}" wire:navigate
                class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Pembagian
                Tugas</a> --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="{{ route('guest.pembelajaran') }}" wire:navigate
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Pembelajaran</h2>
                    ...
                    <a href="{{ route('guest.pembagian-tugas') }}" wire:navigate
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Pembagian Tugas</h2>
